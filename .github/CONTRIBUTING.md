# Contributing to BeatUI

Thank you for considering contributing to **beatui**! Every contribution is valuable, whether it's reporting bugs, suggesting improvements, adding features, or refining README.
...
2. **Clone** your fork:
   ...
   ```bash
   git clone https://github.com/your-username/beatui.git
   ```
...
Thank you for helping make **beatui** better! 🚀

If you have any questions, feel free to reach out via [Discussions](https://github.com/satnaing/beatui/discussions).
